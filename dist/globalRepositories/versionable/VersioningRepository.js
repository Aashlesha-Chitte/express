...
class VersioningRepository {
    ...
    constructor(modelDetails) {
        ...
        this.logger = (0, logger_1.default)('VersioningRepository');
    }
    /**
     * Create new Document
    ...
    create(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.debug('VersioningRepository - Create ::::::', JSON.stringify(options));
            ...
            this.logger.debug('VersioningRepository - Create ::::::start', JSON.stringify(newModel));
            const result = yield newModel.save();
            this.logger.debug('VersioningRepository - Create ::::::end');
    ...
    getAll(conditions = {}, projection, options, populate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.debug('getAll query: ', conditions);
            this.logger.debug('getAll options: ', options);
            this.logger.debug('VersioningRepository - getAll:', JSON.stringify(conditions), JSON.stringify(projection), JSON.stringify(options), JSON.stringify(populate));
            return populate
                ? (yield this.modelDetails
    ...
    update(query, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { user } = options;
            this.logger.debug('Searching for previous valid object...');
            const previous = yield this.get(query);
            if (previous) {
                this.logger.debug('Invalidating previous valid object...');
            ...
            this.logger.debug('Creating new object...');
