...
class ActivationDestinationsRepository extends VersioningRepository_1.default {
    constructor() {
        ...
        this.logger = (0, logger_1.default)('ActivationDestinationsRepository');
        model_1.activationDestinationsModel.createIndexes((error) => {
            if (error) {
    ...
    create(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.logger.debug('ActivationDestinationsRepository - :::::::::::::::Create::::::::::::::');
    ...
    list(query = {}, projection, options = {}, populate) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.logger.debug('ActivationDestinationsRepository - :::::::::::::::List::::::::::::::');
    ...
    get(query = {}, populate) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.logger.debug('ActivationDestination - :::::::::::::::List::::::::::::::');
